...
/*
SecurityCapabilityNegotiationApiService Security Capability Negotiation
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param secNegotiateReqData Custom operation for security capability negotiation
@return models.SecNegotiateRspData
*/
...
func (a *SecurityCapabilityNegotiationApiService) PostExchangeCapability(ctx context.Context, secNegotiateReqData models.SecNegotiateReqData) (models.SecNegotiateRspData, *http.Response, error) {
	var (
		...
		localVarReturnValue  models.SecNegotiateRspData
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/exchange-capability"
	...
	// body params
	localVarPostBody = &secNegotiateReqData
