...
/*
ParameterExchangeApiService Parameter Exchange
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param secParamExchReqData Custom operation for parameter exchange
@return models.SecParamExchRspData
*/
...
func (a *ParameterExchangeApiService) PostExchangeParams(ctx context.Context, secParamExchReqData models.SecParamExchReqData) ( models.SecParamExchRspData, *http.Response, error) {
	var (
		...
		localVarReturnValue  models.SecParamExchRspData
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/exchange-params"
	...
	// body params
	localVarPostBody = &secParamExchReqData
