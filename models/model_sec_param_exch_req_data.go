...
type SecParamExchReqData struct {
	...
	JweCipherSuiteList []string `json:"jweCipherSuiteList,omitempty" yaml:"jweCipherSuiteList" bson:"jweCipherSuiteList"`
	JwsCipherSuiteList []string `json:"jwsCipherSuiteList,omitempty" yaml:"jwsCipherSuiteList" bson:"jwsCipherSuiteList"`
	ProtectionPolicyInfo *ProtectionPolicy `json:"protectionPolicyInfo,omitempty" yaml:"protectionPolicyInfo" bson:"protectionPolicyInfo"`
